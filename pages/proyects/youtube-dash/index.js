...
import TableofVideos from "./components/TableofVideos";
...
export default function index() {
    ...
    const printOnScreen = async(e) =>{
      ...
      console.log(text)
      try{
        const res = await fetch(`http://34.220.116.144/youtube_dash/${text.split("?").pop()}`);
          ...
          <link rel="icon" href="/favicon.ico" />
            ...
            <div>
              ...
              <div className="flex ml-5 items-center">
                ...
                <img title={query[5]['country']} className="ml-3" src={`https://www.countryflags.io/${query[5]['country']}/flat/32.png`}></img>
              </div>
